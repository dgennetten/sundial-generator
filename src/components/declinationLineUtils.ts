...
export const BUILTIN_DECLINATION_LINES: DeclinationLine[] = [
  ...
  { active: false, date: '1st of the Month', styleId: 'dashed-hairline', fixed: true, id: 'month-boundaries' },
  { active: true, date: '1st and 15th', styleId: 'declination-2min-dash', fixed: true, id: 'first-and-fifteenth' },
