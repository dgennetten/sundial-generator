...
const translations: Record<Language, Translations> = {
  en: {
    ...
    steps: {
      ...
      reset: { label: 'Reset to default:', text: 'Click Undo button to restore defaults and bring back this popup.' },
    },
  ...
  es: {
    ...
    steps: {
      ...
      reset: { label: 'Restablecer a predeterminado:', text: 'Haz clic en el botón Deshacer para restaurar los valores predeterminados y volver a mostrar este popup.' },
    },
  ...
  de: {
    ...
    steps: {
      ...
      reset: { label: 'Auf Standard zurücksetzen:', text: 'Klicken Sie auf die Schaltfläche Rückgängig, um die Standardeinstellungen wiederherzustellen und dieses Popup erneut anzuzeigen.' },
    },
  ...
  it: {
    ...
    steps: {
      ...
      reset: { label: 'Ripristina alle impostazioni predefinite:', text: 'Clicca il pulsante Annulla per ripristinare le impostazioni predefinite e riportare questo popup.' },
    },
  ...
  pt: {
    ...
    steps: {
      ...
      reset: { label: 'Redefinir para padrão:', text: 'Clique no botão Desfazer para restaurar os padrões e trazer de volta este popup.' },
    },
  ...
  ar: {
    ...
    steps: {
      ...
      reset: { label: 'إعادة تعيين إلى الافتراضي:', text: 'انقر على زر التراجع لاستعادة الإعدادات الافتراضية وإعادة عرض هذه النافذة المنبثقة.' },
    },
