...
const translations: Record<Language, Translations> = {
  en: {
    ...
    steps: {
      ...
      reset: { label: 'Reset to Defaults:', text: 'Click Undo button to restore defaults and bring back this popup.' },
    },
  ...
  es: {
    ...
    steps: {
      ...
      reset: { label: 'Restablecer a Predeterminados:', text: 'Haz clic en el botón Deshacer para restaurar los valores predeterminados y volver a mostrar este popup.' },
    },
  ...
  fr: {
    ...
    steps: {
      ...
      reset: { label: 'Réinitialiser aux Valeurs par Défaut :', text: 'Cliquez sur le bouton Annuler pour restaurer les paramètres par défaut et réafficher ce popup.' },
    },
  ...
  de: {
    ...
    steps: {
      ...
      reset: { label: 'Auf Standardwerte Zurücksetzen:', text: 'Klicken Sie auf die Schaltfläche Rückgängig, um die Standardeinstellungen wiederherzustellen und dieses Popup erneut anzuzeigen.' },
    },
  ...
  it: {
    ...
    steps: {
      ...
      reset: { label: 'Ripristina le Impostazioni Predefinite:', text: 'Clicca il pulsante Annulla per ripristinare le impostazioni predefinite e riportare questo popup.' },
    },
  ...
  pt: {
    ...
    steps: {
      ...
      reset: { label: 'Redefinir para Padrões:', text: 'Clique no botão Desfazer para restaurar os padrões e trazer de volta este popup.' },
    },
  ...
  zh: {
    ...
    steps: {
      ...
      reset: { label: '重置为默认值：', text: '点击撤销按钮以恢复默认设置并重新显示此弹出窗口。' },
    },
  ...
  ja: {
    ...
    steps: {
      ...
      reset: { label: 'デフォルトにリセット：', text: '元に戻すボタンをクリックしてデフォルト設定に戻し、このポップアップを再表示してください。' },
    },
  ...
  ko: {
    ...
    steps: {
      ...
      reset: { label: '기본값으로 재설정:', text: '실행 취소 버튼을 클릭하여 기본값을 복원하고 이 팝업을 다시 표시하세요.' },
    },
  ...
  ru: {
    ...
    steps: {
      ...
      reset: { label: 'Сбросить к Значениям по Умолчанию:', text: 'Нажмите кнопку Отменить, чтобы восстановить настройки по умолчанию и вернуть это всплывающее окно.' },
    },
  ...
  ar: {
    ...
    steps: {
      ...
      reset: { label: 'إعادة التعيين إلى الافتراضيات:', text: 'انقر على زر التراجع لاستعادة الإعدادات الافتراضية وإعادة عرض هذه النافذة المنبثقة.' },
    },
