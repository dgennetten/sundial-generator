...
const translations: Record<Language, Translations> = {
  en: {
    ...
    steps: {
      ...
      specialDates: { label: 'Add special dates', text: ': Enter Day and Month in Declination Lines. Uncheck Today to remove the red line with today\'s date.' },
    },
  ...
  es: {
    ...
    steps: {
      ...
      specialDates: { label: 'Añade fechas especiales', text: ': Ingresa Día y Mes en Líneas de Declinación. Desmarca Hoy para eliminar la línea roja con la fecha de hoy.' },
    },
  ...
  fr: {
    ...
    steps: {
      ...
      specialDates: { label: 'Ajoutez des dates spéciales', text: ': Entrez le Jour et le Mois dans les Lignes de Déclinaison. Décochez Aujourd\'hui pour supprimer la ligne rouge avec la date d\'aujourd\'hui.' },
    },
  ...
  de: {
    ...
    steps: {
      ...
      specialDates: { label: 'Fügen Sie besondere Daten hinzu', text: ': Geben Sie Tag und Monat in Deklinationslinien ein. Deaktivieren Sie Heute, um die rote Linie mit dem heutigen Datum zu entfernen.' },
    },
  ...
  it: {
    ...
    steps: {
      ...
      specialDates: { label: 'Aggiungi date speciali', text: ': Inserisci Giorno e Mese nelle Linee di Declinazione. Deseleziona Oggi per rimuovere la linea rossa con la data di oggi.' },
    },
  ...
  pt: {
    ...
    steps: {
      ...
      specialDates: { label: 'Adicione datas especiais', text: ': Insira Dia e Mês nas Linhas de Declinação. Desmarque Hoje para remover a linha vermelha com a data de hoje.' },
    },
  ...
  zh: {
    ...
    steps: {
      ...
      specialDates: { label: '添加特殊日期', text: '：在赤纬线中输入日期和月份。取消选中"今天"以移除带有今天日期的红线。' },
    },
  ...
  ja: {
    ...
    steps: {
      ...
      specialDates: { label: '特別な日付を追加', text: '：赤緯線に日と月を入力します。今日の日付の赤い線を削除するには、「今日」のチェックを外します。' },
    },
  ...
  ko: {
    ...
    steps: {
      ...
      specialDates: { label: '특별한 날짜 추가', text: '：적위선에 일과 월을 입력합니다. 오늘 날짜의 빨간 선을 제거하려면 "오늘"의 체크를 해제하세요.' },
    },
  ...
  ru: {
    ...
    steps: {
      ...
      specialDates: { label: 'Добавьте особые даты', text: ': Введите День и Месяц в Линиях Склонения. Снимите флажок Сегодня, чтобы удалить красную линию с сегодняшней датой.' },
    },
  ...
  ar: {
    ...
    steps: {
      ...
      specialDates: { label: 'أضف تواريخ خاصة', text: ': أدخل اليوم والشهر في خطوط الانحراف. قم بإلغاء تحديد "اليوم" لإزالة الخط الأحمر مع تاريخ اليوم.' },
    },
