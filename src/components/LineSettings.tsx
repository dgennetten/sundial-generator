...
export type LineStyle = {
  ...
  calculatedType?: 'declination-2min-dot' | 'declination-5min-dot' | 'hourline-5-2-day-dash' | 'declination-2min-dash' | 'declination-5min-dash' | 'hourline-2-5-day-dash' | 'hourline-2-2-day-dash'; // for calculated styles
